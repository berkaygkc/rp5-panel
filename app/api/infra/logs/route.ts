...
/** Container'ın son log satırları: /api/infra/logs?system=<id>&container=<docker id> */
export async function GET(req: Request) {
  ...
  try {
    return NextResponse.json(await getBeszelMonitor().containerLogs(system, container));
  } catch (err) {
